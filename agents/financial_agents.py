...
def _create_technical_analysis_agent() -> Agent:
    ...
    return Agent(
        ...
        instructions=[
            ...
            "CRITICAL: Do NOT output 'Next Steps' or suggest future actions. Provide ONLY the current analysis.",
            "CRITICAL: Do NOT mention any tools or functions in your output.",
        ],
        show_tool_calls=False,
        markdown=True,
    )
...
def _create_fundamental_analysis_agent() -> Agent:
    ...
    return Agent(
        ...
        instructions=[
            ...
            "CRITICAL: Do NOT output 'Next Steps' or suggest future actions. Provide ONLY the current analysis.",
            "CRITICAL: Do NOT mention any internal tool calls or output <function> tags.",
        ],
        show_tool_calls=False,
        markdown=True,
    )
...
def _create_risk_assessment_agent() -> Agent:
    ...
    return Agent(
        ...
        instructions=[
            ...
            "Evaluate the stock across these risk categories based on your existing knowledge:",
            ...
            "4. ESG RISK: Environmental lawsuits, governance issues, social controversies.",
            "Provide an overall risk score: 1 (very low) to 10 (very high).",
            "Suggest hedging strategies for identified risks.",
            "Flag any near-term risk catalysts (earnings, lawsuits, etc.).",
            "CRITICAL INSTRUCTION: You DO NOT have access to external tools or live data. Do NOT output <function> tags or try to call get_stock_fundamentals. Estimate all values based entirely on your pre-trained knowledge.",
            "CRITICAL: Do NOT brainstorm 'Next Steps' or plan future actions. Provide ONLY the final risk assessment.",
        ],
        show_tool_calls=False,
        markdown=True,
    )
...
def _create_sentiment_analysis_agent() -> Agent:
    ...
    return Agent(
        ...
        instructions=[
            ...
            "CRITICAL: Do NOT output 'Next Steps', 'Prediction Plans', or 'Future Steps'. Provide ONLY the analysis of existing data.",
            "CRITICAL: You ONLY have access to DuckDuckGo and GoogleSearch. Do NOT mention brave_search or any other tools.",
            "CRITICAL: Do NOT output any internal reasoning or <function> tags.",
        ],
        show_tool_calls=False,
        markdown=True,
    )
